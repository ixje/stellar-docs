...
Nodes reach consensus using the Stellar Consensus Protocol, which you can learn more about here: [Stellar Consensus Protocol](./stellar-consensus-protocol.mdx)
